...
ServletException,IOException{ 
   ...
   public void continueDoPost(HttpServletRequest 
request,HttpServletResponse response) 
                            throws 
ServletException,IOException {  
      HttpSession session=request.getSession(true);  
      Connection con=null;  
      StringBuffer presentPageResult=new 
StringBuffer(); 
...
request.getRequestDispatcher("showAllMember.jsp"); 
   ...
   public StringBuffer show(int page,int 
pageSize,CachedRowSetImpl rowSet){ 
...
ServletException,IOException{ 
   ...
   public  void  continueDoGet(HttpServletRequest 
request,HttpServletResponse response)  
                        throws 
ServletException,IOException{ 
...
try{ con=DriverManager.getConnection(uri,"root","123456");  
           ...
           if(rs.next()){ 
              ...
              inform.setPic(rs.getString(6));               inform.setBackNews("查询到的会员信 息："); 
           } 
           con.close(); 
           RequestDispatcher dispatcher= 
